...
es05 <- subset(es, es$year == 2005)
summary(es05)

es12 <- subset(es, es$year == 2012)
summary(es12)

inference(x = as.factor(year), y = response, data = es, statistic = "proportion", type = "ht", alternative = 'twosided', method = "theoretical", success = "atheist")
```
...
summary(us)
inference(x = as.factor(year), y = response, data = us, statistic = "proportion", type = "ht", alternative = 'twosided', method = "theoretical", success = "atheist")
```
